...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || HelpRequested(gArgs)) {
        ...
        std::string strUsage = PACKAGE_NAME " obscuritycoin-tx utility version " + FormatFullVersion() + "\n\n" +
            "Usage:  obscuritycoin-tx [options] <hex-tx> [commands]  Update hex-encoded obscuritycoin transaction\n" +
            "or:     obscuritycoin-tx [options] -create [commands]   Create hex-encoded obscuritycoin transaction\n" +
            "\n";
