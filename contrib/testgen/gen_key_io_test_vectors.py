...
bech32_templates = [
  ...
  ('obsc',    0, 20, (False, 'main',    None, True), Encoding.BECH32,  p2wpkh_prefix),
  ('obsc',    0, 32, (False, 'main',    None, True), Encoding.BECH32,  p2wsh_prefix),
  ('obsc',    1, 32, (False, 'main',    None, True), Encoding.BECH32M, p2tr_prefix),
  ('obsc',    2,  2, (False, 'main',    None, True), Encoding.BECH32M, (OP_2, 2)),
  ('tobsc',    0, 20, (False, 'test',    None, True), Encoding.BECH32,  p2wpkh_prefix),
  ('tobsc',    0, 32, (False, 'test',    None, True), Encoding.BECH32,  p2wsh_prefix),
  ('tobsc',    1, 32, (False, 'test',    None, True), Encoding.BECH32M, p2tr_prefix),
  ('tobsc',    3, 16, (False, 'test',    None, True), Encoding.BECH32M, (OP_3, 16)),
  ('tobsc',    0, 20, (False, 'signet',  None, True), Encoding.BECH32,  p2wpkh_prefix),
  ('tobsc',    0, 32, (False, 'signet',  None, True), Encoding.BECH32,  p2wsh_prefix),
  ('tobsc',    1, 32, (False, 'signet',  None, True), Encoding.BECH32M, p2tr_prefix),
  ('tobsc',    3, 32, (False, 'signet',  None, True), Encoding.BECH32M, (OP_3, 32)),
  ('robsc',  0, 20, (False, 'regtest', None, True), Encoding.BECH32,  p2wpkh_prefix),
  ('robsc',  0, 32, (False, 'regtest', None, True), Encoding.BECH32,  p2wsh_prefix),
  ('robsc',  1, 32, (False, 'regtest', None, True), Encoding.BECH32M, p2tr_prefix),
  ('robsc', 16, 40, (False, 'regtest', None, True), Encoding.BECH32M, (OP_16, 40))
]
...
bech32_ng_templates = [
  ...
  ('tobsc',   17, 32, Encoding.BECH32M, False, False, False),
  ('robsc',  3,  1, Encoding.BECH32M, False, False, False),
  ('obsc',   15, 41, Encoding.BECH32M, False, False, False),
  ('tobsc',    0, 16, Encoding.BECH32,  False, False, False),
  ('robsc',  0, 32, Encoding.BECH32,  True,  False, False),
  ('obsc',    0, 16, Encoding.BECH32,  True,  False, False),
  ('tobsc',    0, 32, Encoding.BECH32,  False, True,  False),
  ('robsc',  0, 20, Encoding.BECH32,  False, False, True),
  ('obsc',    0, 20, Encoding.BECH32M, False, False, False),
  ('tobsc',    0, 32, Encoding.BECH32M, False, False, False),
  ('robsc',  0, 20, Encoding.BECH32M, False, False, False),
  ('obsc',    1, 32, Encoding.BECH32,  False, False, False),
  ('tobsc',    2, 16, Encoding.BECH32,  False, False, False),
  ('robsc', 16, 20, Encoding.BECH32,  False, False, False),
]
