# Support for Output Descriptors in ObscurityCoin Core

Since ObscurityCoin Core v0.17, there is support for Output Descriptors. This is a
...
- Segwit addresses (bech32, of the form `obsc1...` for mainnet or `tobsc1...` for testnet, defined in [BIP 173](https://github.com/bitcoin/bips/blob/master/bip-0173.mediawiki)).
...
existing ObscurityCoin Core wallets, a convenience function `combo` is
