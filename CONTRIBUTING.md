Contributing to ObscurityCoin Core
============================

The ObscurityCoin Core project operates an open contributor model where anyone is
...
Before you start contributing, familiarize yourself with the ObscurityCoin Core build
...
The developer
[mailing list](https://groups.google.com/forum/#!forum/obscuritycoin-dev)
...
the pull request affects. Valid areas as:
  ...
  - `qt` or `gui` for changes to obscuritycoin-qt
...
The following applies to code changes to the ObscurityCoin Core project (and related
projects such as libsecp256k1), and is not to be confused with overall ObscurityCoin
Network Protocol consensus changes.

Whether a pull request is merged into ObscurityCoin Core rests with the project merge
...
Patches that change ObscurityCoin consensus rules are considerably more involved than
...
Where a patch set proposes to change the ObscurityCoin consensus, it must have been
...
The project leader is the release manager for each ObscurityCoin Core release.
