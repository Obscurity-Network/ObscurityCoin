...
"""Verify that starting obscuritycoin with -h works as expected."""
...
class HelpTest(BitcoinTestFramework):
    ...
    def run_test(self):
        self.log.info("Start obscuritycoin with -h for help text")
        ...
        self.log.info("Start obscuritycoin with -version for version information")
        ...
        self.log.info("Start obscuritycoind with -fakearg to make sure it does not start")
